                    ...
                    <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                        ...
                        <div class="">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="#">Responsable des Ventes</a></li>
                                <!--end nav-item-->
                            ...
                            <div class="card bg-welcome-img overflow-hidden">
                                <div class="card-body">
                                    <div class="">
                                        ...
                                        <a href="<?= BASE_URL ?>public/responsable/rapports/"
                            ...
                            <div class="card bg-globe-img">
                                <div class="card-body">
                                    <div>
                                        ...
                                        <a href="<?= BASE_URL ?>public/responsable/rapports/"><button type="button" class="btn btn-soft-warning" data-bs-toggle="modal"
                                            data-bs-target="#transferModal">
                                            Benéfices
                                        </button></a>
                                        <a href="<?= BASE_URL ?>public/responsable/depenses/" class="btn btn-soft-danger">
                                            Dépenses
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            <h6 class="my-0 fw-normal text-dark fs-13 mb-0">
                                                Vous avez 1.530.000 FBU restant...<a
                                                    href="<?= BASE_URL ?>public/responsable/rapports/"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="text-center mt-3">
                                <a href="<?= BASE_URL ?>public/responsable/ventes/" class="btn btn-warning">Voir toutes les
                                    ventes</a>
                            </div>
                        </div>
                        <!--end card-body-->
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <!--end col-->
                                <div class="col-auto">
                                    <a href="<?= BASE_URL ?>public/responsable/clients/" class="btn btn-light">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--end /div-->
                            <div class="text-center mt-3">
                                <a href="<?= BASE_URL ?>public/responsable/clients/"

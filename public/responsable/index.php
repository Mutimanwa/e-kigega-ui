                            ...
                            <div class="card bg-globe-img">
                                <div class="card-body">
                                    <div>
                                        ...
                                        <a href="<?= BASE_URL ?>public/responsable/rapports/"><button type="button" class="btn btn-soft-primary" data-bs-toggle="modal"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="text-center mt-3">
                                <a href="<?= BASE_URL ?>public/responsable/ventes/" class="btn btn-primary">Voir toutes les
                                    ventes</a>
                            </div>
                        </div>
                        <!--end card-body-->

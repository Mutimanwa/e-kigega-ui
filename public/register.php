                            ...
                            <div class="card">
                                <div class="card-body p-0 bg- auth-header-box rounded-top">
                                    <div class="text-center ">
                                        ...
                                        <h4 class="mt-n3 fw-semibold  fs-18">Create an account</h4>   
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-12">
                                                <div class="form-check form-switch form-switch-success">
                                                    ...
                                                    <label class="form-check-label" for="customSwitchSuccess">By registering you agree to the Approx <a href="#" class="text-warning">Terms of Use</a></label>
                                                </div>
                                            </div><!--end col--> 
                                        </div><!--end form-group--> 
                                        ...
                                        <div class="form-group mb-0 row">
                                            <div class="col-12">
                                                <div class="d-grid mt-3">
                                                    <button class="btn btn-warning" type="button">Register <i class="fas fa-sign-in-alt ms-1"></i></button>
                                                </div>
                                            </div><!--end col--> 
                                        </div> <!--end form-group-->                           
                                    </form><!--end form-->

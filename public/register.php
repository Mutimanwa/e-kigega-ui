                                ...
                                <div class="card">
                                    <div class="card-body p-0 bg- auth-header-box rounded-top">
                                        <div class="text-center ">
                                            ...
                                            <p class="text-muted fw-medium mb-0">Entrez vos informations pour créer
                                                votre compte aujourd'hui .</p>
                                        </div>
                                    </div>
                                    <div class="card-body pt-0">
                                        <form class="my-3" action="index.php">
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="email" class="form-control" id="useremail"
                                                    name="user email" placeholder="Entrez votre email">
                                            </div><!--end form-group-->
                                            ...
                                            <div class="form-group mb-2 position-relative">
                                                <label class="form-label" for="Confirmpassword">Confirmer le mot de
                                                    passe</label>
                                                <input type="password" class="form-control pe-5" name="password_confirm"
                                                    id="Confirmpassword" placeholder="Confirmez votre mot de passe">
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" class="form-control" id="mobileNo"
                                                    name="mobile number" placeholder="Entrez votre numéro de mobile">
                                            </div><!--end form-group-->
                                            ...
                                            <div class="form-group row mt-3">
                                                <div class="col-12">
                                                    <div class="form-check form-switch form-switch-warning">
                                                        ...
                                                        <label class="form-check-label" for="customSwitchSuccess">En
                                                            vous inscrivant, vous acceptez les <a href="#"
                                                                class="text-warning">Conditions
                                            ...
                                            <div class="form-group mb-0 row">
                                                <div class="col-12">
                                                    <div class="d-grid mt-3">
                                                        <button class="btn btn-warning" type="button">S'inscrire <i
                                        ...
                                        <div class="text-center">
                                            <p class="text-muted">Vous avez déjà un compte ? <a href="./../index.php"
                                                    class="text-warning ms-2">Se connecter</a></p>
                                        </div>
                                    </div><!--end card-body-->
                                </div><!--end card-->
                            </div><!--end col-->

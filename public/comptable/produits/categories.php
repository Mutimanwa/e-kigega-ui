   ...
   title="Supprimer" ></i>
      ...
      <div class="modal fade" id="addRate" tabindex="-1" aria-labelledby="addRateLabel" aria-hidden="true">
        <div class="modal-dialog">
          <form action="./../../../backend/comptable/categorie/add.php" method="post">
      ...
      <div class="modal fade" id="modifyRate" tabindex="-1">
        <div class="modal-dialog">
          <form method="POST" action="./../../../backend/comptable/categorie/update.php">
            <div class="modal-content">
      ...
      <div class="modal fade" id="deleteModal" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <form method="POST" action="./../../../backend/comptable/categorie/delete.php">

                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute top-50 start-100 translate-middle">
                                                <div
                                                    class="thumb-sm border border-3 border-white bg-success rounded-circle d-flex align-items-center justify-content-center">
                                                    <i class="las la-user text-white fs-12"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 text-truncate ms-3 mb-1 align-self-end">
                                            <h5 class="m-0 fs-3 fw-bold"><?= htmlspecialchars($users['nom']) ?>
                                ...
                                <div class="col-lg-12">
                                    <div class="mt-3">
                                        <div class="text-body mb-2 d-flex align-items-center">
                                            ...
                                            <span
                                                class="badge bg-primary ms-2"><?= htmlspecialchars($users['role']) ?></span>
                                        </div>
                                        ...
                                        <div class="text-muted mb-2 d-flex align-items-center">
                                            ...
                                            <a href="mailto:<?= htmlspecialchars($users['email']) ?>"
                                        ...
                                        <div class="text-body mb-3 d-flex align-items-center">
                                            ...
                                            <span
                                                class="ms-2"><?= htmlspecialchars((new DateTime($users['created_at']))->format('d/m/Y')) ?></span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control password-input" id="passwordEdit"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control password-input"
                                            id="confirmPasswordEdit" placeholder="Confirmer mot de passe">
                                        <span class="input-group-text toggle-password"
                                            data-target="confirmPasswordEdit">
                                            <i class="iconoir-eye-closed"></i>
                                        </span>
                                    </div>
                                </div>

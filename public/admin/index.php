                                        ...
                                        <div>
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <form class="">
                                                    <select id="dynamic-select" name="example-select"
                                                        ...
                                                        <option value="1" data-img="assets/images/logos/m-card.png">
                                                            xx25
                                                        </option>
                                            ...
                                            <p class="mb-3 text-muted fw-semibold">
                                                <span class="text-success"><i
                                                        class="fas fa-arrow-up me-1"></i>11.1%</span>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-2">
                                                <h6 class="my-0 fw-normal text-dark fs-13 mb-0">
                                                    You have $1.53 remaining found over ...<a href="#"
                                    ...
                                    <div class="col-auto">
                                        <div class="dropdown">
                                            <a href="#" class="btn bt btn-light">
                                                <i class="icofont-contact-add fs-5 me-1"></i> Add
                                                Member
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table mb-0">
                                        <tbody>
                                            <tr class="">
                                                ...
                                                <td class="px-0 text-end">
                                                    <a href="#" class="text-body"><i class="las la-sync-alt"></i></a>
                                                </td>
                                            </tr>
                                            <!--end tr-->
                                            <tr class="">

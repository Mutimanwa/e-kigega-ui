...
if (!$entreprise) {
    header("Location: ./../../../public/admin/fournisseurs/index.php?error=Entreprise non définie");
    exit;
}
...
if (isset($_POST['send'])) {
    ...
    if ($nom === "" || $prenom === "" || $email === "" || $telephone === "" || $adresse ==="") {
        header("Location: ./../../../public/admin/fournisseurs/index.php?error=Données invalides");
        exit;
    }
    ...
    if ($add === "Erreur lors de la création") {
        header("Location: ./../../../public/admin/fournisseurs/index.php?error=Erreur lors de l’ajout");
        exit;
    }

    if (isset($add['id'])) {
        header("Location: ./../../../public/admin/fournisseurs/index.php?success=Client ajouté avec succès");
        exit;
    }

<?php
    ...
    if (!isset($_POST['send'], $_POST['id'], $_POST['nom'], $_POST['prenom'], $_POST['email'], $_POST['telephone'] ,$_POST['adresse'])) {
        header("Location: ./../../../public/admin/clients/index.php?error=Données manquantes");
        exit;
    }
    ...
    if ($update === true) {
        header("Location: ./../../../public/admin/clients/index.php?success=Client modifié avec succès");
    } elseif ($update === "login") {
        session_destroy();
        header("Location: ./../../../index.php");
    } else {
        header("Location: ./../../../public/admin/clients/index.php?error=Erreur lors de la modification");
    }

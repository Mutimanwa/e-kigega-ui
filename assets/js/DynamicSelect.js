    ...
    for (let t = 0; t < this.data.length; t++) {
      ...
      (e =
        ...
        `
                    ${
                      this.data[t].img
                        ? `<img src="${this.data[t].img}" alt="${
                            this.data[t].text
                          }" class="${
                            this.data[t].imgWidth && this.data[t].imgHeight
                              ? "dynamic-size"
                              : ""
                          }" style="${
                            this.data[t].imgWidth
        ...
        (i += `
                <div class="dynamic-select-option${
                  this.data[t].value == this.selectedValue
        ...
        }" data-value="${this.data[t].value}" style="width:${s}%;${
    ...
    this.element.querySelectorAll(".dynamic-select-option").forEach((t) => {
      t.onclick = () => {
        this.element
          ...
          .forEach((e) => e.classList.remove("dynamic-select-selected")),
          ...
          this.options.onChange(
            ...
            t.querySelector(".dynamic-select-option-text")
              ? t.querySelector(".dynamic-select-option-text").innerHTML
              : "",
            t
          );
      };
      ...
      document.addEventListener("click", (e) => {
        e.target.closest("." + this.name) ||
          e.target.closest('label[for="' + this.selectElement.id + '"]') ||
          this.element
            .querySelector(".dynamic-select-header")
            .classList.remove("dynamic-select-header-active");
      });
